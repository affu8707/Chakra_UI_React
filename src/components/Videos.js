    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
          ...
          <Text>
            This is a sample Video for testing and demo. Lorem ipsum dolor sit
            amet consectetur adipisicing elit. Similique, placeat. Illo
            aspernatur totam earum ea! Mollitia, quae possimus? Doloribus
            facilis itaque maxime, nam repudiandae veritatis eius! Eligendi fuga
            magni deserunt?
          </Text>
        </VStack>
      </VStack>
